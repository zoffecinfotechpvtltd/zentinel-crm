...
export function Logo({ size = 30 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path d="M11.4 10.4h9.4l-7.55 9.25h7.55" stroke="#f8fafc" strokeWidth="2.3" strokeLinecap="round" strokeLinejoin="round" />
      <g stroke="#a8f0ff" strokeWidth="1.3" strokeLinecap="round">
        <path d="M23.1 8.2a4.3 4.3 0 0 1 0 6" opacity=".95" />
        <path d="M24.7 6.5a6.8 6.8 0 0 1 0 9.4" opacity=".5" />
      </g>
      <circle cx="21.7" cy="11.2" r="1.15" fill="#eafcff" />
    </svg>
  );
}
